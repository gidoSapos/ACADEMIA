...
from funcoes import on_buscar_exercicio, on_listar_exercicios, on_cadastrar_exercicio, \
on_remover_exercicio, on_cadastrar_treino, on_listar_treinos, on_buscar_treino, \
on_remover_treino, on_atualizar_exercicio,on_atualizar_treino
...
def criar_interface():
    ...
    icone = tk.PhotoImage(file = 'img/icon.png')
